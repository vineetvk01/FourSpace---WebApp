...
--
-- Host: localhost:3306
-- Generation Time: Oct 11, 2017 at 11:33 PM
...
CREATE TABLE `designers` (
  `id` int(11) NOT NULL,
  `name` varchar(200) NOT NULL,
  `status` enum('verified','new') NOT NULL,
  ...
  `accreditions` varchar(200) NOT NULL,
  `about` text NOT NULL,
...
--
-- Table structure for table `d_featured`
--

CREATE TABLE `d_featured` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `image` text NOT NULL,
...
--
-- Indexes for table `d_featured`
--
ALTER TABLE `d_featured`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `d_featured`
--
ALTER TABLE `d_featured`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
